...
#Key: In Kaggle website go to Your profile then account then create new token then kaggle.json will downloaded from that get key
...
get_ipython().system('pip install scikit-image==0.16.2')
...
get_ipython().system('pip uninstall pydot')
get_ipython().system('pip uninstall pydotplus')
get_ipython().system('pip uninstall graphviz')
